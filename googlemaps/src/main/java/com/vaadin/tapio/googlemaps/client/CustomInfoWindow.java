 ...
 *
 */
public class CustomInfoWindow extends MVCObject<CustomInfoWindow> {
     ...
     */
    public static final CustomInfoWindow newInstance(InfoWindowOptions options) {
    ...
    public final native void close() /*-{
        @com.vaadin.tapio.googlemaps.client.WindowWidgetContainer::detachWidget(Lcom/vaadin/tapio/googlemaps/client/CustomInfoWindow;)(this);
        this.close();
    }-*/;
    ...
    public final void setContent(Widget widget) {
        WindowWidgetContainer.addWindowWithWidget(this, widget);
